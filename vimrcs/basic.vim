...
" Maintainer: 
"       Jade
"       https://github.com/rushsinging/vimplus
"
" Sections:
"    -> General
"    -> VIM user interface
...
" Sets no compatible with old vi
set nocompatible
...
" Use ripgrep to search and <leader><space> to search selected words
map <leader>g :Rg 
nnoremap <C-f> :Rg<CR>
vnoremap <leader><space> "hy:Rg <C-r>h<CR>
