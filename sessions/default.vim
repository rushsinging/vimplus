...
inoremap <silent> <SNR>64_yrrecord =YRRecord3()
...
map ,bd :Bclose
map <silent> , :noh
map ,E :split =expand("%:p:h")/
map ,e :vsplit =expand("%:p:h")/
nmap ,w :w!
nmap 0 ^
vmap 0 ^
nmap @ :YRMapsMacro
...
nnoremap <silent> <SNR>64_yrrecord :call YRRecord3()
...
set runtimepath+=~/.vim/plugged/vim-mustache-handlebars/
set runtimepath+=~/.vim/plugged/nginx.vim/
set runtimepath+=~/.vim/plugged/vim-jenkinsfile/
set runtimepath+=~/.vim/plugged/vim-vue/
...
set runtimepath+=~/.vim/plugged/coc-fzf/
set runtimepath+=~/.vim/plugged/vim-go/
set runtimepath+=~/.vim/plugged/vim-node/
set runtimepath+=~/.vim/plugged/vim-python-pep8-indent/
set runtimepath+=/opt/homebrew/share/vim/vimfiles
set runtimepath+=/opt/homebrew/share/vim/vim90
...
set runtimepath+=~/.vim/plugged/coc-fzf/after
...
silent only
silent tabonly
cd ~/Documents/work/lanhu/magicbox_2/application
...
badd +0 config/base.py
argglobal
%argdel
$argadd config/base.py
edit config/base.py
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 518 - ((25 * winheight(0) + 20) / 41)
